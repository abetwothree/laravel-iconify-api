...
{
    /**
     * Coerce a raw rotation into the number JavaScript would carry around.
     *
     ...
     *
     * Strings go through rotateFromString(), which upstream applies to component
     * props. We also accept them on icon data, where upstream would produce NaN and
     * so no rotation; the package's own icon types have always allowed a string there.
     */
